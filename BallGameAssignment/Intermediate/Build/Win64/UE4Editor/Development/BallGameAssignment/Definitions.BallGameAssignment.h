...
#define UE_PROJECT_NAME BallGameAssignment
#define UE_TARGET_NAME BallGameAssignmentEditor
#define UE_MODULE_NAME "BallGameAssignment"
...
#define BALLGAMEASSIGNMENT_API DLLEXPORT
